...
{
    /// <summary>
    ///     Builds a Bootstrap text input field with label, validation attributes, optional input group icon, and constraint
    ///     badges.
    /// </summary>
    /// <remarks>
        ...
        ICanUseCustomClasses
    {
        ...
        ///     The value rendered in the <c>type</c> attribute, such as <c>text</c>, <c>email</c>, or
        ///     <c>number</c>.
        /// </param>
        /// <returns>The current <see cref="TextFieldBuilder" /> instance for fluent chaining.</returns>
