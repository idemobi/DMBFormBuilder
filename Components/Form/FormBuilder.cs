...
// DMBFormBuilder.csproj FormBuilder.cs create at 2026/05/12
...
namespace DMBFormBuilder
{
        ...
        ICanUsePadding
    {
        ...
        /// </summary>
        /// <param name="value">
        /// <see langword="true"/> to set <c>enctype="multipart/form-data"</c>; <see langword="false"/> leaves the current attributes unchanged.
        /// </param>
        /// <returns>The current <see cref="FormBuilder"/> instance for fluent chaining.</returns>
        ...
        /// </summary>
        /// <param name="value">
        /// <see langword="true"/> to render <c>novalidate</c>; <see langword="false"/> leaves the current attributes unchanged.
        /// </param>
        /// <returns>The current <see cref="FormBuilder"/> instance for fluent chaining.</returns>
